 ...
 * 
 * Content:
 * - Backend code for the request view (Accepted) page
...
{
    public partial class RequestViewA : System.Web.UI.Page
    {
        //SQL Connection
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (ddFilter.Text == "View Accepted")
            {
                //Do nothing
            }
            else if (ddFilter.Text == "View Pending")
            {
